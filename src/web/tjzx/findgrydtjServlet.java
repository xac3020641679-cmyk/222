...
//查看别人的月度订单汇总
@WebServlet("/findgrydtjServlet")
public class findgrydtjServlet extends HttpServlet {
    @Override
...
//        从username返回phone
        ...
        User user = dao2.findmyphone(username);
...
//        统计页面订单当月所有订单金额
        ...
        request.setAttribute("operator",username2);
        request.setAttribute("starttime",starttime);
        request.getRequestDispatcher("tjzx-yhtj-gryd.jsp").forward(request,response);
    }
}
